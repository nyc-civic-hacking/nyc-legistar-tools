...
const TranscriptInputs: React.FC<TranscriptInputProps> = ({ initialTranscripts, getTranscripts }) => {
    ...
    return (
        <>
            <select name='year' defaultValue={year} onChange={(e) => setYear(e.target.value)}>
